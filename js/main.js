function showAllWeeks() {
    ...
    const links = [
        ...
        { label: "Week Five", url: "weekFive/index.html", description: "This week was primarily about testing and debugging. The quiz invokes some console.log() lines indicating if everything is working correctly or not. In the group project we created a list of hikes."}
    ];
